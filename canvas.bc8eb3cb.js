...
},{}],"../scripts/canvas.js":[function(require,module,exports) {
"use strict";
...
var BaseCanvasEngine =
/*#__PURE__*/
function (_Engine) {
  _inherits(BaseCanvasEngine, _Engine);

  var _super = _createSuper(BaseCanvasEngine);

  function BaseCanvasEngine() {
    var _this;

    _classCallCheck(this, BaseCanvasEngine);
  ...
  return BaseCanvasEngine;
}(_engine.default);

document.addEventListener("DOMContentLoaded", function () {
  var engine = new BaseCanvasEngine();
  engine.addToDOM();
  engine.render();
});
