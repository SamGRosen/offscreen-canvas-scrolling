...
function (_Engine) {
  ...
  _createClass(OffscreenEngine, [{
    key: "addToDOM",
    value: function addToDOM(workerName) {
      var _this2 = this;
      ...
      this.worker = new Worker("../scripts/".concat(workerName, "-worker.js"));
...
document.addEventListener("DOMContentLoaded", function (e) {
  var pathName = e.target.location.pathname; // Remove slash and .html

  var workerName = pathName.substring(1, pathName.length - 5);
  var engine = new OffscreenEngine();
  engine.addToDOM(workerName);
  engine.render();
});
var _default = OffscreenEngine;
exports.default = _default;
},{"fpsmeter":"../../node_modules/fpsmeter/dist/fpsmeter.js","./engine":"../scripts/engine.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../scripts/offscreen-engine.js"], null)
//# sourceMappingURL=/scripts/offscreen-engine.js.map