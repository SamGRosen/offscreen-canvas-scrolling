...
},{}],"scripts/offscreen-webgl-worker.js":[function(require,module,exports) {
"use strict";
...
var OffscreenWebGLWorker =
/*#__PURE__*/
function (_OffscreenWorker) {
  _inherits(OffscreenWebGLWorker, _OffscreenWorker);

  var _super = _createSuper(OffscreenWebGLWorker);

  function OffscreenWebGLWorker(data) {
    var _this;

    _classCallCheck(this, OffscreenWebGLWorker);
  ...
  _createClass(OffscreenWebGLWorker, [{
    key: "animate",
    value: function animate() {
    ...
    value: function render() {
      ...
      this.shaderProgram = initShaderProgram(this.gl, vertexShader, fragmentShader);
      this.programInfo = {
  ...
  return OffscreenWebGLWorker;
}(_offscreenWorker.default);

self.onmessage = OffscreenWebGLWorker.onmessager(self);
...
//# sourceMappingURL=/scripts/offscreen-webgl-worker.js.map