...
function (_Drawer) {
  ...
  _createClass(WebGLCanvasDrawer, [{
    ...
    value: function renderTSNE() {
      ...
      this.xTSNEScale = (0, _utilities.scale)([-10, 10], [-1, 1]);
      this.yTSNEScale = (0, _utilities.scale)([-10, 10], [-1, 1]);
      this.shaderProgram = (0, _utilities.initShaderProgram)(this.gl, _webgl.colorPointsVertexShader, _webgl.colorPointsFragmentShader);
      this.programInfo = {
        program: this.shaderProgram,
        attribLocations: {
      ...
      var _iterator = _createForOfIteratorHelper(this.csv),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var point = _step.value;
          positions.push(this.xTSNEScale(point.geometry.coordinates[0]), this.yTSNEScale(point.geometry.coordinates[1]));
          colors.push.apply(colors, _toConsumableArray(this.sampleColors.get(point.sample)));
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
...
exports.default = _default;
},{"./drawer":"../scripts/drawer.js","./utilities":"../scripts/utilities.js","./webgl.js":"../scripts/webgl.js"}],"../scripts/offscreen-canvas-webgl-worker.js":[function(require,module,exports) {
"use strict";
...
var OffscreenWebGLCanvasDrawer =
/*#__PURE__*/
function (_WebGLCanvasDrawer) {
  _inherits(OffscreenWebGLCanvasDrawer, _WebGLCanvasDrawer);

  var _super = _createSuper(OffscreenWebGLCanvasDrawer);

  function OffscreenWebGLCanvasDrawer() {
    _classCallCheck(this, OffscreenWebGLCanvasDrawer);

    return _super.apply(this, arguments);
  }

  _createClass(OffscreenWebGLCanvasDrawer, [{
    key: "tick",
    value: function tick() {
      postMessage({
        type: "tick"
  ...
  return OffscreenWebGLCanvasDrawer;
}(_canvasWebglDrawer.default);

self.onmessage = (0, _utilities.createMessanger)(OffscreenWebGLCanvasDrawer, self);
},{"./canvas-webgl-drawer":"../scripts/canvas-webgl-drawer.js","./utilities":"../scripts/utilities.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
